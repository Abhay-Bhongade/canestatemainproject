...
import PersonalDetailsInTenant from "./Tenant/PersonalDetailsInTenant";
import AddressDetailsInTenant from "./Tenant/AddressDetailsInTenant";
import BankDetailsInTenant from "./Tenant/BankDetailsInTenant";
...
function ColorlibStepIcon(props) {
  ...
  const icons = {
    ...
    2: <LocationOnIcon sx={{ fontSize: "19px" }} />,
    3: <AccountBalanceOutlinedIcon sx={{ fontSize: "19px" }} />,
  };
...
function getStepContent(step) {
  switch (step) {
    case 0:
      return (
        <>
          <PersonalDetailsInTenant />
        </>
      );
    case 1:
      return (
        <>
          <AddressDetailsInTenant />
        </>
      );
    case 2:
      return (
  ...
  return (
    <div>
      ...
      {activeStep === 3 ? (
        ...
        <div className="address-details-container tenants-container">
...
export default TenatsStepperFrom;
